...
const fallbackCategories = [
  {
    ...
    icon: '💻',
    accentColor: '#3b82f6',
    description: 'Code, projects, and dev content'
  },
  {
    slug: 'fitness',
    ...
    icon: '🏋️',
    accentColor: '#22c55e',
    description: 'Lifts, PRs, and training'
  },
  {
    slug: 'fpv',
    title: 'FPV Drones',
    icon: '🚁',
    accentColor: '#f97316',
    description: 'Builds, flights, and reviews'
  },
  {
    slug: 'travel',
    title: 'Travel',
  ...
  },
  {
    ...
    icon: '🎮',
    accentColor: '#a855f7',
    description: 'Games, clips, and streams'
  },
  {
    slug: 'blog',
    title: 'Blog',
    icon: '📝',
    accentColor: '#f43f5e',
    description: 'Thoughts and lifestyle'
  }
]
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(ellipse 80% 80% at 50% 120%, ${accent}20 0%, transparent 70%)`
                }}
              />
              ...
              {'coverImage' in cat && (cat as Category).coverImage && (
                <div className='absolute inset-0 opacity-10 group-hover:opacity-15 transition-opacity'>
                  <Image
                    src={urlFor((cat as Category).coverImage!)
                      .width(400)
                      .height(300)
                      .url()}
                    alt={cat.title}
              ...
              <div className='relative'>
                <div className='flex items-start justify-between'>
                  ...
                  >
                    {'postCount' in cat
                      ? `${(cat as Category).postCount ?? 0} posts`
                      : '→'}
                  </span>
                </div>
