      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-16'>
        ...
        <div className='lg:col-span-2'>
          ...
          {about?.bio ? (
            <div className='prose'>
              <PortableText
                value={about.bio as Parameters<typeof PortableText>[0]['value']}
              />
            </div>
          ) : (
            <div className='space-y-4 text-[var(--muted)]'>
              <p>
                Software engineer building things by day, lifting heavy weights,
                flying FPV drones, and streaming games by night.
              </p>
              <p>
                This site is where I document it all — projects, travel
                adventures, drone builds, and whatever else catches my
                attention.
              </p>
            </div>
          )}
