...
export default async function LinksPage() {
  const socialLinks = await client
    .fetch<SocialLink[]>(socialLinksQuery)
    .catch(() => [])

  const fallback: Partial<SocialLink>[] = [
    {
      platform: 'YouTube',
      url: 'https://youtube.com/@jumpalottahigh',
      username: '@jumpalottahigh'
    },
    {
      platform: 'TikTok',
      url: 'https://tiktok.com/@jumpalottahigh',
      username: '@jumpalottahigh'
    },
    {
      platform: 'GitHub',
      url: 'https://github.com/jumpalottahigh',
      username: 'jumpalottahigh'
    },
    {
      platform: 'Twitch',
      url: 'https://twitch.tv/jumpalottahigh',
      username: 'jumpalottahigh'
    },
    {
      platform: 'Instagram',
      url: 'https://instagram.com/jumpalottahigh',
      username: '@jumpalottahigh'
    }
  ]
        ...
        {links.map((link) => {
          ...
          return (
            ...
            >
              ...
              <span className='text-[var(--muted)] group-hover:text-white group-hover:translate-x-0.5 transition-all'>
                →
              </span>
            </a>
          )
