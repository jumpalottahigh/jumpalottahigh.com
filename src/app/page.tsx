...
import { categoriesQuery, recentPostsQuery, socialLinksQuery, aboutQuery } from "@/sanity/queries";
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 border-t border-[var(--border)]">
        ...
        {recentPosts.length > 0 ? (
          ...
          <div className="text-center py-16">
            <p className="text-[var(--muted)]">No posts yet. Add content in Sanity Studio.</p>
            <Link
              href="/studio"
